...
2–8,6 ms; a diferença atribuiu-se, por inferência, à escrita durável do selo. O **AOS-401** emendou o ADR-026: o SLO governa só a política. A medida directa do **AOS-402** (2026-09-17, v0.1.19) desmentiu a inferência: a escrita custa 6,5–8,3 ms e política + escrita ≈ 12–13 ms, pelo que a diferença para os ~31 ms da v0.1.15 não é da escrita.
