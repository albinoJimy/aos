...
| **ADR-022** | Extensões declarativas ao grafo de plano: arestas condicionais, papel verificador e payload tipado por aresta — sem ciclos, sem blackboard | Aceite | 8 | AOS-270, AOS-271, AOS-272, AOS-273, AOS-278, AOS-279, AOS-390, AOS-413 | `tecnica/09`, `tecnica/11` |
...
- **Sub-cobertura (≤3 tickets):** 
  ...
  - **ADR-027** (Cada nó despachado de um plano do `aos-orq` executa como um run do nó `aos` (`POST /runs` + `GET /runs/{id}`): NHI do run cunhado pelo operador e montado em ficheiro, campo `tools` como lista-branca imposta antes da mediação (ausente ⇒ sem restrição, vazia ⇒ nenhuma tool), veredicto por gramática fechada (ilegível ⇒ `fail`), conclusão durável escrita pelo `aos-orq` sob o lease (completa o ADR-024, dentro do ADR-018/023)) — 1 ticket(s): AOS-413.
...
|---|---|---|
| `tecnica/00_Arquitectura_Solucao.md` | Todos (transversal) | AOS-001 – AOS-413 |
...
| `tecnica/09_Governacao_Conformidade.md` | EPIC-09, EPIC-01, EPIC-02, EPIC-06, EPIC-08, EPIC-10, EPIC-14, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-087 – AOS-097 (+ AOS-190 – AOS-413) |
| `tecnica/10_Topologia_Implantacao_Operacao.md` | EPIC-10, EPIC-11 | AOS-098 – AOS-108 (+ AOS-118) |
| `tecnica/11_Convencoes_Engenharia_Evolucao.md` | EPIC-11 (+ EPIC-05 auto-mod), EPIC-01, EPIC-02, EPIC-06, EPIC-08, EPIC-09, EPIC-10, EPIC-14, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-109 – AOS-118 (+ AOS-045–054, + AOS-190 – AOS-413) |
...
| `tecnica/16_Rastreabilidade_RTM.md` | Todos (transversal — meta-rastreabilidade) | AOS-001 – AOS-413 |
...
flowchart LR
    ...
    EPIC --> TICK["AOS-001..AOS-413 (tickets)"]
...
| GAP-05 | **Ausência de coluna de estado** — a RTM regista cobertura de *especificação*, não de *implementação concluída*: nenhum dos 413 tickets do corpus traz estado Done/WIP para esta matriz | §4–5 | Ligar a RTM ao *tracker* (estado por ticket) na próxima revisão |
