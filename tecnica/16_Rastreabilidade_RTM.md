...
- **Sub-cobertura (≤3 tickets):** 
  ...
  - **ADR-028** (Um objectivo entra no caminho do plano por um FACTO gravado pelo nó, e o `aos-orq` consome-o sob a posse que já governa o run: o ingresso é rota do nó e NÃO importa o orquestrador (ADR-018 intacto); o consumo-uma-só-vez segue o molde de idempotency-key já existente, sem substrato de fila novo; um `serve` continua a possuir um run e a terminar (ADR-023 intacto); e um pedido sobre um run com posse responde `201 accepted` idempotente — NUNCA o estado do run —, para não reabrir o oráculo de existência que o ADR-016 fecha) — 1 ticket(s): AOS-417.
...
|---|---|---|
| `tecnica/00_Arquitectura_Solucao.md` | Todos (transversal) | AOS-001 – AOS-422 |
...
| `tecnica/09_Governacao_Conformidade.md` | EPIC-09, EPIC-01, EPIC-02, EPIC-03, EPIC-06, EPIC-08, EPIC-10, EPIC-14, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-087 – AOS-097 (+ AOS-190 – AOS-422) |
| `tecnica/10_Topologia_Implantacao_Operacao.md` | EPIC-10, EPIC-11 | AOS-098 – AOS-108 (+ AOS-118) |
| `tecnica/11_Convencoes_Engenharia_Evolucao.md` | EPIC-11 (+ EPIC-05 auto-mod), EPIC-01, EPIC-02, EPIC-03, EPIC-06, EPIC-08, EPIC-09, EPIC-10, EPIC-14, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-109 – AOS-118 (+ AOS-045–054, + AOS-190 – AOS-422) |
...
| `tecnica/16_Rastreabilidade_RTM.md` | Todos (transversal — meta-rastreabilidade) | AOS-001 – AOS-422 |
...
flowchart LR
    ...
    EPIC --> TICK["AOS-001..AOS-422 (tickets)"]
...
| GAP-05 | **Ausência de coluna de estado** — a RTM regista cobertura de *especificação*, não de *implementação concluída*: nenhum dos 422 tickets do corpus traz estado Done/WIP para esta matriz | §4–5 | Ligar a RTM ao *tracker* (estado por ticket) na próxima revisão |
