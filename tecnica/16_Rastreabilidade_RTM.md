...
A rastreabilidade cobre os 19 ADRs canónicos (`_BRIEF` §3), as 11 capacidades funcionais (`specs/00` §4), os 10 *drivers* não-funcionais (`specs/00` §7) e os **189 tickets** `AOS-001`–`AOS-189` distribuídos por 17 epics. Os dados das matrizes ADR×ticket e NFR×ticket foram extraídos por análise textual dos ficheiros `specs/EPIC-*.md` (correspondência dos códigos `ADR-0NN` e `AOS-NNN` por bloco de ticket), não por atribuição editorial *a posteriori*.
...
| **ADR-005** | Separação control/data-plane + taint | 14 | AOS-013, AOS-023, AOS-039, AOS-042, AOS-044, AOS-046, AOS-049, AOS-054, AOS-069, AOS-071, AOS-075, AOS-117, AOS-133, AOS-158 | `tecnica/02`, `tecnica/03`, `tecnica/04`, `tecnica/05`, `tecnica/06`, `tecnica/07`, `tecnica/08`, `tecnica/09`, `tecnica/10`, `tecnica/11`, `tecnica/12`, `tecnica/15` |
...
| **ADR-012** | SemVer + eval-gate para auto-modificação | 23 | AOS-035, AOS-040, AOS-041, AOS-044, AOS-045, AOS-047, AOS-048, AOS-049, AOS-050, AOS-051, AOS-052, AOS-053, AOS-054, AOS-084, AOS-096, AOS-106, AOS-114, AOS-115, AOS-126, AOS-129, AOS-159, AOS-160, AOS-189 | `tecnica/02`, `tecnica/04`, `tecnica/05`, `tecnica/06`, `tecnica/07`, `tecnica/08`, `tecnica/09`, `tecnica/10`, `tecnica/11`, `tecnica/12`, `tecnica/15` |
...
| **ADR-017** | Supply-chain do nó `aos` e da sua distribuição (binário zero-dep, imagem distroless/non-root, SBOM+proveniência) | 3 | AOS-129, AOS-169, AOS-185 | `tecnica/02`, `tecnica/09`, `tecnica/10`, `tecnica/12`, `tecnica/15` |
...
| **ADR-019** | Excepções intencionais às fronteiras canónicas de camada (v1 single-host) | 1 | AOS-179 | `tecnica/09`, `tecnica/12` |
...
- **Sub-cobertura (≤3 tickets):** 
  ...
  - **ADR-017** (Supply-chain do nó `aos` e da sua distribuição (binário zero-dep, imagem distroless/non-root, SBOM+proveniência)) — 3 ticket(s): AOS-129, AOS-169, AOS-185.
  - **ADR-018** (Fronteira nó↔ORQ/SCH: o loop de serviço é a fonte única de verdade do ciclo de vida (v1 single-host)) — 2 ticket(s): AOS-164, AOS-185.
  - **ADR-019** (Excepções intencionais às fronteiras canónicas de camada (v1 single-host)) — 1 ticket(s): AOS-179.
