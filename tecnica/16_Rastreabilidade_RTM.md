...
| **ADR-008** | Admission control global em tokens/$ | Catálogo, por materializar | 27 | AOS-008, AOS-026, AOS-027, AOS-028, AOS-029, AOS-030, AOS-031, AOS-032, AOS-033, AOS-034, AOS-037, AOS-059, AOS-062, AOS-063, AOS-078, AOS-080, AOS-105, AOS-106, AOS-107, AOS-116, AOS-123, AOS-259, AOS-260, AOS-270, AOS-280, AOS-287, AOS-321 | `tecnica/01`, `tecnica/03`, `tecnica/04`, `tecnica/06`, `tecnica/08`, `tecnica/09`, `tecnica/10`, `tecnica/11`, `tecnica/15` |
...
| **ADR-014** | Taxonomia de autonomia L0–L5 | Catálogo, por materializar | 5 | AOS-022, AOS-089, AOS-090, AOS-125, AOS-380 | `tecnica/02`, `tecnica/09`, `tecnica/11`, `tecnica/15` |
...
|---|---|---|
| `tecnica/00_Arquitectura_Solucao.md` | Todos (transversal) | AOS-001 – AOS-382 |
...
| `tecnica/09_Governacao_Conformidade.md` | EPIC-01, EPIC-09, EPIC-10, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-087 – AOS-097 (+ AOS-190 – AOS-382) |
| `tecnica/10_Topologia_Implantacao_Operacao.md` | EPIC-10, EPIC-11 | AOS-098 – AOS-108 (+ AOS-118) |
| `tecnica/11_Convencoes_Engenharia_Evolucao.md` | EPIC-01, EPIC-05 (auto-mod), EPIC-10, EPIC-11, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22, EPIC-23, EPIC-24, EPIC-25 | AOS-109 – AOS-118 (+ AOS-045–054, + AOS-190 – AOS-382) |
...
| `tecnica/16_Rastreabilidade_RTM.md` | Todos (transversal — meta-rastreabilidade) | AOS-001 – AOS-382 |
...
flowchart LR
    ...
    EPIC --> TICK["AOS-001..AOS-382 (tickets)"]
...
| GAP-05 | **Ausência de coluna de estado** — a RTM regista cobertura de *especificação*, não de *implementação concluída*: nenhum dos 381 tickets do corpus traz estado Done/WIP para esta matriz | §4–5 | Ligar a RTM ao *tracker* (estado por ticket) na próxima revisão |
