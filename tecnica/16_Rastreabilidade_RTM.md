...
|---|---|---|
| `tecnica/00_Arquitectura_Solucao.md` | Todos (transversal) | AOS-001 – AOS-316 |
...
| `tecnica/09_Governacao_Conformidade.md` | EPIC-01, EPIC-09, EPIC-10, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22 | AOS-087 – AOS-097 (+ AOS-190 – AOS-316) |
| `tecnica/10_Topologia_Implantacao_Operacao.md` | EPIC-10, EPIC-11 | AOS-098 – AOS-108 (+ AOS-118) |
| `tecnica/11_Convencoes_Engenharia_Evolucao.md` | EPIC-01, EPIC-05 (auto-mod), EPIC-10, EPIC-11, EPIC-16, EPIC-18, EPIC-19, EPIC-20, EPIC-21, EPIC-22 | AOS-109 – AOS-118 (+ AOS-045–054, + AOS-190 – AOS-316) |
...
| `tecnica/16_Rastreabilidade_RTM.md` | Todos (transversal — meta-rastreabilidade) | AOS-001 – AOS-316 |
...
| GAP-05 | **Ausência de coluna de estado** — a RTM regista cobertura de *especificação*, não de *implementação concluída*: nenhum dos 316 tickets do corpus traz estado Done/WIP para esta matriz | §4–5 | Ligar a RTM ao *tracker* (estado por ticket) na próxima revisão |
