...
**Eixo POR ATRIBUIR — legal hold, retenção e bundle de política.** A **superfície de administração de legal hold e retenção** (achado CON-02) e a **superfície de carregamento de bundle de política no binário** continuam deferidas para `specs/EPIC-09` — um *epic*, não um ticket. Esta frase é deliberadamente a forma textual do defeito DEF-01 e fica visível como tal: enquanto o eixo não for atribuído, é uma dívida sem executor, não um plano.
