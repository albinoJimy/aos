...
| **[13_Auditoria_GOV_OBS_Adversarial.md](13_Auditoria_GOV_OBS_Adversarial.md)** | **Transversal**: GOV (políticas/PDP, RBAC e identidade, autonomia L0–L5) e OBS (spans OTel GenAI, replay, audit WORM) — incluindo `otel-genai/`, que a 12 §7.2 declarou fora de âmbito. 75 hipóteses, 30 sobreviventes (19 alcançáveis, 6 de alta severidade), mais 7 achados nascidos na refutação; a escada L0–L5 sai **sem base normativa** e o trilho WORM apaga registos válidos em silêncio (medido) | 2026-09-06 |
