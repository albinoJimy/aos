...
func TestAOS278_ValidCredentialProceeds(t *testing.T) {
	...
	mc, err := newGatewayModelClient(verifier, srv.URL, "gpt-4o", "", defaultModelGatewayRegion, defaultModelGatewayBoard, nil, nil, nil, nil, false, nil)
	if err != nil {
...
func TestAOS278_UnboundVerifierFailsClosedThenBinds(t *testing.T) {
	...
	mc, err := newGatewayModelClient(holder, srv.URL, "gpt-4o", "", defaultModelGatewayRegion, defaultModelGatewayBoard, nil, nil, nil, nil, false, nil)
	if err != nil {
		t.Fatalf("newGatewayModelClient: %v", err)
	}
	ctx := withModelCredential(context.Background(), aos278Mint(t, auth, "model:invoke"))
...
func TestAOS278_CredentialSurvivesResumeThreading(t *testing.T) {
	...
	inner, err := newGatewayModelClient(verifier, srv.URL, "gpt-4o", "", defaultModelGatewayRegion, defaultModelGatewayBoard, nil, nil, nil, nil, false, nil)
	if err != nil {
		t.Fatalf("newGatewayModelClient: %v", err)
	}
