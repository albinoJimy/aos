...
// Event Store e termina sempre num humano responsável (ADR-003).
...
type Principal struct {
	...
	// emite-a como obrigação `region` que o PEP impõe (enforceRegion). Vazio ⇒ sem
...
// PortVersion é a versão SemVer da porta C1 (contrato de mediação) que o RM
