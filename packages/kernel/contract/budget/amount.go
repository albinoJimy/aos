...
// reconstrução sobre entrada potencialmente adversarial/corrompida do Event Store; o
// caminho normal de reserva não transborda (limitado pelo limit).
...
// ValidReserve indica se a quantia é uma reserva legítima: nenhuma dimensão
