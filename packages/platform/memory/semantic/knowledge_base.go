...
// de conhecimento.
//
// O NOME MUDOU (AOS-424): era `memory.semantic.knowledge`, com pontos. Um `stream_id` do AOS é livre,
...
// for ligado.
const KnowledgeStreamID = "aos-internal/memory/semantic-knowledge"
