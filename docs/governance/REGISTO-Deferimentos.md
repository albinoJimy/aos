...
| DEF-304 | DOCUMENTAL | packages/kernel/agent-runtime/durable/step_ledger.go | Mesma dívida no ledger durável, com o eixo antigo `EPIC-13` ainda escrito no comentário (ficheiro fora do âmbito de AOS-196 — ver pendência P-2) | AOS-093 (ver A-DEF-301) | Responsável de Segurança | Idem DEF-301 | ABERTO |
