...
3. **Doc 19 §9.1 desactualizado.** Diz que a demoção automática não vigora (DEF-908). O banner deste commit declara `democao automatica por anomalia (AOS-090/DEF-908): LIGADA` e `promocao automatica por fiabilidade (AOS-090/ADR-025): LIGADA`. Passo 1.
